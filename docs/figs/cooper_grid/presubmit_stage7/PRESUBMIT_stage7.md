...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| [632888](params_632888.txt) | 911 | **F** | **30.0** | 0.89e-3 | 2.25e-8 | 0.01 | 2.250e-10 | 2.5e-13 | 1.0e-13 | uniform | `const_rate_5.0e-03.txt` | 0.37 | 11.10 | 11.50 | 30.66 |
| [632889](params_632889.txt) | 911 | **T** | **30.0** | 0.89e-3 | 2.25e-8 | 0.01 | 2.250e-10 | 2.5e-13 | 1.0e-13 | uniform | `const_rate_5.0e-03.txt` | 0.37 | 11.10 | 11.50 | 30.66 |

## Derived hydraulics

| run | D near m²/s | D far m²/s | str=beta*phi | T at kpmin | T at kpmax | gamma(h=60s, kpmin) | gamma(h=60s, kpmax) |
|---|---|---|---|---|---|---|---|
| 632888 | 4.9938e-01 | 4.9938e-01 | 2.250e-10 | 1.855e-10 | 4.638e-10 | 0.3993 | 0.2101 |
| 632889 | 4.9938e-01 | 4.9938e-01 | 2.250e-10 | 1.855e-10 | 4.638e-10 | 0.3993 | 0.2101 |
...
|---|---|---|---|---|
| 632888 | 0.37 | 11.50 | -42.45 | can fail |
| 632889 | 0.37 | 11.50 | -42.45 | can fail |
...
- [`res632888.in` vs `res911.in`](diff_632888.txt)
- [`res632889.in` vs `res911.in`](diff_632889.txt)

## Launch commands, once approved

```bash
cd /home/groups/edunham/nberrios/3dhbi/examples/grid_search_inputs
sbatch march26_submit_hbi_git_scratch.sh -i res632888.in -w june_clean.txt
sbatch march26_submit_hbi_git_scratch.sh -i res632889.in -w june_clean.txt
```
